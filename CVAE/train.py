...
parser.add_argument('--prop_file', help='name of property file', type=str,default='data/duotai_data/L4_aas.txt') ##data txt
...
parser.add_argument('--num_epochs', help='epochs', type=int, default=300) ##epochs
parser.add_argument('--lr', help='learning rate', type=float, default=0.0001)
parser.add_argument('--num_prop', help='number of propertoes', type=int, default=1)
parser.add_argument('--save_dir', help='save dir', type=str, default='save/peptide/L4_aas') ##ckpt
